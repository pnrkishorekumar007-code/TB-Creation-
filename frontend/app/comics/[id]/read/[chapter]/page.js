    ...
    return (
      <div className="bg-ink min-h-screen">
        <div className="max-w-3xl mx-auto px-5 py-16 text-center">
          {status === 'unavailable' ? (
            <>
              <p className="font-display text-2xl mb-2">Chapter Not Available</p>
              <p className="text-muted mb-6">
                This chapter isn't open yet, or the comic is unavailable.
              </p>
              <Link href={`/comics/${id}`} className="text-accent hover:underline">
                ← Back to comic
              </Link>
            </>
          ) : (
